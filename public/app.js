  ...
  $.getJSON("/articles", function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      $("#results").prepend("<p class='data-entry' data-id=" + data[i]._id + "><span class='dataTitle' data-id=" +
        data[i]._id + ">" + data[i].title + " | by " + data[i].author + " | " + data[i].date + " </span> (" + "<a href='#' target=_blank>comment here</a>" + " | " + "<a href=" + data[i].link + " target=_blank>" + "go to external article)" + "</p>");
    }
  });
}
